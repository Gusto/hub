Feature: ghub compare
  ...
  Scenario: Compare 2-dots range for SHAs
    When I successfully run `ghub compare 1234abc..3456cde`
    Then there should be no output
  ...
  Scenario: Compare 2-dots range with "user:repo" notation
    When I successfully run `ghub compare henrahmagix:master..2b10927`
    Then there should be no output
  ...
  Scenario: Complex range is unchanged
    When I successfully run `ghub compare @{a..b}..@{c..d}`
    Then there should be no output
  ...
  Scenario: Compare fork
    When I successfully run `ghub compare anotheruser feature`
    Then there should be no output
