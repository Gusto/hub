Feature: ghub submodule add
  ...
  Scenario: Add public submodule
    When I successfully run `ghub submodule add mojombo/grit vendor/grit`
  ...
  Scenario: Add private submodule
    When I successfully run `ghub submodule add -p mojombo/grit vendor/grit`
    Then the "vendor/grit" submodule url should be "git@github.com:mojombo/grit.git"

  Scenario: Add submodule with arguments
    When I successfully run `ghub submodule add -b foo --name grit mojombo/grit vendor/grit`
  ...
  Scenario: Add submodule with branch
    When I successfully run `ghub submodule add --branch foo mojombo/grit vendor/grit`
